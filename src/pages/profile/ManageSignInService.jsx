   ...
   return (
      <div className="mt-[60px] flex flex-col items-center  min-h-screen">
         <div className="mx-24">
            ...
            <p className="mt-8">
               Псевдоним учетной записи — это адрес электронной почты, номер телефона или имя Skype, которые используются для входа в учетную запись Майкрософт. У вас может быть несколько псевдонимов для использования в службах Майкрософт, таких как Outlook.com, Skype, OneDrive, Office, Xbox, Windows и многих других.
            </p>
            <p className="mt-6">
               Основной псевдоним вашей учетной записи отображается на устройствах Майкрософт (таких как компьютер с Windows, Xbox или Windows Phone), и вы можете в любое время выбрать в качестве основного другой псевдоним. {" "}
