      ...
      <>
         <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50" onClick={onClose}>
            ...
            >
               ...
               <button
                  onClick={onClose}
                  className="absolute top-2 right-2 p-1 rounded-md hover:translate-y-[-3px] transition-transform duration-200 hover:bg-gray-600"
               >
                  <AiOutlineClose size={20} />
               </button>
               {/* Контент диалога */}
               <div className="flex justify-between items-center mb-4">
                  <div className="flex language-container px-5 py-2 items-center">
                     ...
                     <div className="language-container flex flex-col items-center">
                        <h2 className="language-title text-xl font-semibold ml-6 truncate overflow-hidden whitespace-nowrap">
