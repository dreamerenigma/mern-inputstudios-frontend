...
export default function ChangeRegionalFormatModal({
   ...
   return (
      <>
         ...
         <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-1/3 bg-white dark:bg-gray-800 p-4 shadow-lg z-50 rounded-lg">
            ...
            <div className="px-2">
               ...
               <div className="mb-4">
                  ...
                  <select
                     ...
                     className="w-full p-2 border rounded-md dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-teal-500"
                  >
