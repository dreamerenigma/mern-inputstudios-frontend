               ...
               >
                  ...
                  <div className="text-center">
                     ...
                     <div className="flex justify-between w-full gap-4">
                        <button
                           className="px-4 py-2 bg-red-600 dark:hover:bg-red-800 hover:bg-red-700 shadow-md rounded-lg flex-grow text-white"
                           onClick={handleDeleteUser}
                        >
                           {t("yes_sure")}
                        </button>
                        <button
                           className="px-4 py-2 bg-gray-300 dark:bg-gray-700 hover:bg-gray-400 hover:dark:bg-gray-600 shadow-md rounded-lg flex-grow"
                           onClick={() => setShowModal(false)}
                        >
                           {t("no_cancel")}
                        </button>
