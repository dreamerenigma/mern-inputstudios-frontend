      ...
      <div className="min-h-screen w-full bg-gray-100 dark:bg-[rgb(16,23,42)]">
         ...
         <div className="overview flex flex-col max-w-5xl w-full h-auto mt-2 mx-auto px-4">
            ...
            <div className="w-full md:w-3/2 mx-auto max-w-5xl flex items-center mt-8 "> 
               <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full rounded-lg shadow-md transition-colors duration-300 bg-white border border-gray-300 dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="w-full md:w-3/2 mx-auto max-w-5xl flex items-center mt-6">
               <div className="w-full rounded-lg shadow-md transition-colors duration-300 bg-white border-gray-300 dark:border-gray-700 dark:bg-gray-800 border">
            ...
            <div className="w-full mx-auto max-w-5xl flex items-center mt-6 mb-14">
               <div className="w-full rounded-lg shadow-md transition-colors duration-300 bg-white border-gray-300 dark:border-gray-700 dark:bg-gray-800 p-6 border">
